module Telegrammer
  module DataTypes
    # Telegram ReplyKeyboardMarkup2 data type.
    #
    ...
    class ReplyKeyboardMarkup2 < Telegrammer::DataTypes::Base
      attribute :keyboard, Array[Array[ Telegrammer::DataTypes::ReplyKeyboardMarkup2Button ]]
